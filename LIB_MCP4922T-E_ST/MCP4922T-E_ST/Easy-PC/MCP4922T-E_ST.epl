SamacSys ECAD Model
674770/174461/2.43/14/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MCP4922T-E_ST" (originalName "MCP4922T-E_ST")
	...
	(compDef "MCP4922T-E_ST" (originalName "MCP4922T-E_ST") (compHeader (numPins 14) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "5" (pinName "SDI") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "14" (pinName "VOUTA") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "13" (pinName "VREFA") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "12" (pinName "VSS") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "11" (pinName "VREFB") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "10" (pinName "VOUTB") (partNum 1) (symPinNum 12) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "9" (pinName "__SHDN") (partNum 1) (symPinNum 13) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "__LDAC") (partNum 1) (symPinNum 14) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MCP4922T-E_ST"))
		...
		(attr "Manufacturer_Part_Number" "MCP4922T-E/ST")
		(attr "Mouser Part Number" "579-MCP4922T-E/ST")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=579-MCP4922T-E%2FST")
		(attr "RS Part Number" "1773123")
		(attr "RS Price/Stock" "https://uk.rs-online.com/web/p/products/1773123")
		(attr "Allied_Number" "70451631")
		(attr "Allied Price/Stock" "https://www.alliedelec.com/microchiptechnologyinc-mcp4922t-e-st/70451631/")
		(attr "Description" "MICROCHIP - MCP4922T-E/ST - DAC, 12BIT, -40 TO 125DEG C, TSSOP")
		(attr "Datasheet Link" "http://ww1.microchip.com/downloads/en/devicedoc/22250a.pdf")
		(attr "Height" "1.2 mm")
	)
