...
(library Library_1
	...
	(patternDef "LGA_PACKAGE_20_PINS" (originalName "LGA_PACKAGE_20_PINS")
		(multiLayer
			...
			(pad (padNum 8) (padStyleRef r60_30) (pt 0.5, -1.9) (rotation 90))
			(pad (padNum 9) (padStyleRef r60_30) (pt 0, -1.9) (rotation 90))
			(pad (padNum 10) (padStyleRef r60_30) (pt -0.5, -1.9) (rotation 90))
			...
			(pad (padNum 18) (padStyleRef r60_30) (pt -0.5, 1.9) (rotation 90))
			(pad (padNum 19) (padStyleRef r60_30) (pt 0, 1.9) (rotation 90))
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.4 2.25) (pt -1.5 2.15) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.2 2.25) (pt -1.5 1.95) (width 0.025))
		)
		(layerContents (layerNumRef 18)
		...
		(layerContents (layerNumRef 18)
			(arc (pt 2.26, 1.529) (radius 0) (width 0.25))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.1795 2.2245) (pt 1.4795 1.9245) (width 0.025))
		)
	)
	...
	(compDef "BMX055" (originalName "BMX055") (compHeader (numPins 20) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "INT2") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "2" (pinName "DRDYM") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "VDD") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "4" (pinName "GNDA") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "5" (pinName "CSB2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "6" (pinName "GNDIO") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Power))
		...
		(compPin "9" (pinName "SCX") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "10" (pinName "INT5") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "11" (pinName "SDX") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "12" (pinName "SDO2") (partNum 1) (symPinNum 12) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "13" (pinName "VDDIO") (partNum 1) (symPinNum 13) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "14" (pinName "INT3") (partNum 1) (symPinNum 14) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "15" (pinName "INT4") (partNum 1) (symPinNum 15) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "16" (pinName "CSB1") (partNum 1) (symPinNum 16) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "17" (pinName "SDO1") (partNum 1) (symPinNum 17) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "18" (pinName "NC_2") (partNum 1) (symPinNum 18) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "19" (pinName "INT1") (partNum 1) (symPinNum 19) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "20" (pinName "CSB3") (partNum 1) (symPinNum 20) (gateEq 0) (pinEq 0) (pinType Input))
		...
		(attr "<Hyperlink>" "http://www.mouser.com/ds/2/621/BST-BMX055-DS000-02-586421.pdf")
	)
